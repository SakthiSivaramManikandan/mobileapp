            ...
            <div className="flex p-4">
                ...
                <div className="mt-4 ms-4">
                    ...
                    <h3 className="text-2xl mt-4">Year: <span
                        className="text-orange-900 text-3xl">{movie.Year}</span></h3>
                    <h3 className="text-2xl mt-4">Plot: <span
                        className="text-orange-900 text-3xl">{movie.Plot}</span></h3>
                    <h3 className="text-2xl mt-4">Actors: <span
                        className="text-orange-900 text-3xl">{movie.Actors}</span></h3>
